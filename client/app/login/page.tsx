...
export default function LoginPage() {
  ...
  return (
    <motion.div
      ...
      className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#fafafa] px-6"
    >
      <motion.div
        initial={{ scale: 1.25 }}
        animate={{ scale: 1 }}
      ...
      >
        <div className="mb-10 flex flex-col items-center">
          <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-full border border-black/10 bg-white/70 shadow-sm backdrop-blur-xl">
          ...
          <h1 className="text-lg font-medium text-[#18181b]">
        ...
        <button
          ...
          className={`flex h-12 w-full items-center justify-center gap-3 rounded-full ${classNames.button.primary.bg}
            from-[#7079f0] to-[#5E6AD2] text-sm font-medium cursor-pointer
            text-white shadow-[0_10px_40px_rgba(94,106,210,0.25)] transition-all hover:brightness-105 active:scale-[0.98]`}
        >
          <GoogleIcon />
